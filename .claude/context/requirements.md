...
- Filtering by status or region (APAC-2902)
- Column sorting (APAC-2903)
- Export to CSV (APAC-2935)
- Policy detail drill-down on row click (APAC-2850)
- Dark mode (design system ticket TBD)
